...
>* It's not perfect yet, but listen to the [Samples](https://soundcloud.com/andabi/sets/voice-style-transfer-to-kate-winslet-with-deep-neural-networks)!
>* Special thanks to [Kyubyong Park](https://github.com/Kyubyong). (Co-worker)
>* We always welcome your questions, advices, or contributions.
## Intro
